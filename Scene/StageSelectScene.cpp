...
void StageSelectScene::Initialize() {
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW + 300, halfH / 2 + 250, 400, 100);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::MainGameOnClick, this));
    AddNewControlObject(btn);
...
void StageSelectScene::MainGameOnClick() {
