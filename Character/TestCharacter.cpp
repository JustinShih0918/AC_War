...
TestCharacter::TestCharacter(int x, int y, int player) : Character("play/enemy-4.png", x, y, 400, 30, 500, 3, 1, player) {
...
void TestCharacter::CreateBullet(Character* character) {
